...
export type PreferenceKey = 'duration' | 'companion' | 'interest' | 'energy'
...
export const preferenceQuestions: PreferenceQuestion[] = [
  {
    ...
    title: '今天有多少时间',
    options: [
      { value: '90', label: '90 分钟', helper: '推荐路线，完成 4-5 个棋格' },
      { value: '60', label: '60 分钟', helper: '轻体验，跳过较远节点' },
      { value: '150', label: '150 分钟', helper: '完整线，可解锁更多回声' },
    ],
  },
  {
    key: 'companion',
    title: '这次和谁一起',
    options: [
      { value: 'friends', label: '朋友', helper: '对话选择更轻松，任务适合协作拍照' },
      { value: 'solo', label: '独自', helper: '更偏内心独白和个人游记' },
      { value: 'family', label: '亲子', helper: '观察任务更明确，语言更适合讲给孩子' },
    ],
  },
  {
    key: 'interest',
    title: '更想追哪种回声',
    options: [
      { value: 'architecture', label: '建筑', helper: '屋檐、轴线、空间秩序会被重点引用' },
      { value: 'life', label: '市井生活', helper: '街声、招牌、胡同和日常会更突出' },
      { value: 'photo', label: '摄影', helper: '任务会更关注构图、光线与画面层次' },
    ],
  },
  {
    key: 'energy',
    title: '今天的步行状态',
    options: [
      { value: 'normal', label: '正常走', helper: '保持标准主线节奏' },
      { value: 'light', label: '轻松走', helper: '优先短停留，可随时一键终局' },
      { value: 'more', label: '可以多走', helper: '提示景山和什刹海延展玩法' },
    ],
  },
]
